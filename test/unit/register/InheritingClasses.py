...
# This may affect testing, since pipeadapter is an eons.Executor.
...
# When using 'import apie', calling executor.RegisterAllClassesInDirectory(registerPath) made executor.GetRegistered("test", "package") fail. I have no idea why.
import pipeadapter
class inheriting_endpoint(pipeadapter.Fitting):
